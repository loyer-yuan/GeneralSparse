...
modify_col_end_boundary_after_fixed_div_in_row_direction::modify_col_end_boundary_after_fixed_div_in_row_direction(shared_ptr<meta_data_set> meta_data_set_ptr, int target_matrix_id, int fixed_row_gap_size)
    : basic_data_transform_step("modify_col_end_boundary_after_fixed_div_in_row_direction", meta_data_set_ptr)
{
...
void modify_col_end_boundary_after_fixed_div_in_row_direction::run(bool check)
{
    if (check)
    {
...
vector<shared_ptr<data_item_record>> modify_col_end_boundary_after_fixed_div_in_row_direction::get_source_data_item_ptr_in_data_transform_step()
{
    assert(this->target_matrix_id >= 0);
...
vector<shared_ptr<data_item_record>> modify_col_end_boundary_after_fixed_div_in_row_direction::get_dest_data_item_ptr_in_data_transform_step_without_check()
{
    assert(this->target_matrix_id >= 0);
    assert(this->is_run == true);
...
string modify_col_end_boundary_after_fixed_div_in_row_direction::convert_to_string()
{
    assert(this->target_matrix_id >= 0);

    // 打印参数
    string return_str = "modify_col_end_boundary_after_fixed_div_in_row_direction::{name:\"" + this->name + "\",target_matrix_id:" + to_string(this->target_matrix_id) + ",fixed_row_gap_size:" + to_string(this->fixed_row_gap_size) + "}";
