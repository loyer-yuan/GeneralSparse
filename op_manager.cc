...
void var_len_row_div(sparse_struct_t *matrix_struct, dense_block_table_item_t *sub_block, vector<unsigned long> block_first_row_csr_index)
{
    ...
    if (sub_block == NULL)
    {
        ...
        // print_arr_to_file_with_data_type(&(coo_offset_arr[0]), UNSIGNED_LONG, coo_offset_arr.size(), "/home/guoxiao/spmv_builder/data_source/test_result_3");
...
void sep_tblock_level_row_csr(compressed_block_t *compressed_block, vector<unsigned int> block_size_arr)
{
    ...
    if (empty_block_count > 0)
    {
        ...
        // print_arr_to_file_with_data_type(new_coo_begin_index_arr, new_index->data_type_of_coo_begin_index_arr, new_block_number + 1, "/home/guoxiao/spmv_builder/data_source/test5-2.log");
...
void sep_warp_level_row_csr(compressed_block_t *compressed_block, vector<unsigned long> block_index_arr, vector<vector<unsigned int>> row_block_size_arr)
{
    ...
    // 打印coo size
    // print_arr_to_file_with_data_type(&(new_coo_block_size_vec[0]), UNSIGNED_LONG, new_coo_block_size_vec.size(), "/home/guoxiao/spmv_builder/data_source/test5-1.log");
...
void sep_thread_level_col_ell_with_padding(compressed_block_t *compressed_block, vector<unsigned long> block_index_arr, vector<unsigned long> thread_col_block_size)
{
    ...
    for (global_tblock_index = 0; global_tblock_index < old_tblock_index->block_num; global_tblock_index++)
    {
        ...
        for (local_warp_index = warp_begin_index; local_warp_index <= warp_end_index; local_warp_index++)
        {
            ...
            {
                // inner_warp_tmp_result_csr_vec是一个warp内部的归约索引
    ...
    // print_arr_to_file_with_data_type(&(new_warp_index_vec[0]), UNSIGNED_LONG, new_warp_index_vec.size(), "/home/guoxiao/spmv_builder/data_source/test0-7.log");
    ...
    // print_arr_to_file_with_data_type(old_warp_index->index_arr, old_warp_index->index_data_type, old_warp_index->length, "/home/guoxiao/spmv_builder/data_source/test0-6.log");
...
void compressed_block_sort(compressed_block_t *compressed_block, vector<unsigned long> sort_block_index_arr)
{
    ...
    {
        // print_arr_to_file_with_data_type(old_global_row_index->index_arr, old_global_row_index->index_data_type, old_global_row_index->length, "/home/guoxiao/spmv_builder/data_source/test0-2.log");
        ...
        // print_arr_to_file_with_data_type(&(two_direct_index_map[0][0]), UNSIGNED_LONG, two_direct_index_map[0].size(), "/home/guoxiao/spmv_builder/data_source/test0-1.log");
        ...
        for (new_local_row_index = 0; new_local_row_index < block_row_num; new_local_row_index++)
        {
            ...
            // print_arr_to_file_with_data_type(coo_row_index, old_global_row_index->index_data_type, 100, "/home/guoxiao/spmv_builder/data_source/test0-1.log");
        ...
        // 打印row_index
        // print_arr_to_file_with_data_type(coo_row_index, old_global_row_index->index_data_type, old_global_row_index->length, "/home/guoxiao/spmv_builder/data_source/test0-1.log");
    }

    // print_arr_to_file_with_data_type(old_global_row_index->index_arr, old_global_row_index->index_data_type, old_global_row_index->length, "/home/guoxiao/spmv_builder/data_source/test0-1.log");
